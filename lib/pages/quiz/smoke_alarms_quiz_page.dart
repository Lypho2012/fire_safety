...
class SmokeAlarmsQuizPage extends StatefulWidget {
  const SmokeAlarmsQuizPage({Key? key}) : super(key: key);
            ...
            child: ListView(
                children: [
                  Padding(
                      ...
                      child: Text(AppLocalizations.of(context)!.smoke_alarms_quiz_page_title,textScaleFactor: 2)
                  ),
                  Padding(
